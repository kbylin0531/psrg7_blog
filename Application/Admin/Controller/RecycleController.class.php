...
class RecycleController extends AdminBaseController
{
    ...
    {
        $data = ArticleModel::getInstance()->getPageData('all', 'all', 'all', 1);
    ...
    {
        $data = CommentModel::getInstance()->getDataByState(1);
        $this->assign('data', $data['data']);
        $this->assign('page', $data['page']);
        // p($data);
        // die;
    ...
    {
        $data = LinkModel::getInstance()->getDataByState(1);
    ...
    {
        $data = ChatModel::getInstance()->getDataByState(1);
        $this->assign('data', $data);
        // p($data);die;
        $this->display();
    }
